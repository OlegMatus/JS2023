...
// title.textContent = arrayElement.title;
// let monthD = document.createElement('p');
// monthD.textContent = arrayElement.monthDuration;
// div.appendChild(title);
// div.appendChild(monthD);
...
for (let i = 0; i < coursesAndDurationArray2.length; i++) {
    let course = coursesAndDurationArray2[i]
    let div = document.createElement('div');
    div.className = 'item';
...
div.append(title, monthDuration, hourDuration, modules);
    document.body.appendChild(div)
}
// ------------------
